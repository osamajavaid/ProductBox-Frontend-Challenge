        ...
        <div class="w-60 rounded-xl h-[300px]shadow bg-gray-800 z-0">
            ...
            <div class="px-4 pb-5 flex flex-col gap-y-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a onClick={addItemHandler} href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</a>
                </div>
            </div>
        </div >
    )
